...
Etudiants : Sacha Perdrizat & Quentin Le Ray
...
>
> **_Réponse :_** wlan.fc.subtype == 4

---
> **_Question :_** Quel est l’adresse MAC de la cible ?
>
> **_Réponse :_** Avec le filtre suivant (wlan.fc.subtype == 4) && (wlan.ssid == "BlackRainHotel Free Wifi") nous découvrons que la cible possède l'adresse MAC : fc:f1:36:22:49:74

---
> **_Question :_** Quel est le nom du constructeur de l’interface sans fils de la cible ?
>
> **_Réponse :_** Le constructeur est Samsung
